...
CREATE TABLE `animal` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `brinco_identificador` VARCHAR(100) NOT NULL,
  ...
  `valor_compra` DECIMAL(13,2) DEFAULT NULL,
...
CREATE TABLE `historico_sanitario` (
  ...
  `pessoa_id_veterinario` BIGINT NOT NULL COMMENT 'ID da Pessoa com Papel de VETERINÁRIO',
  PRIMARY KEY (`id`),
...
CREATE TABLE `pesagem` (
  ...
  `data_pesagem` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `observacao` TEXT,
...
CREATE TABLE `historico_manejo` (
  ...
  `pessoa_id_operador` BIGINT NOT NULL COMMENT 'ID da pessoa operador responsável pelo Manejo',
  PRIMARY KEY (`id`),
