        ...
        <?php if (!empty($animais)): ?>
          <?php foreach ($animais as $animal): ?>
            <tr>
              ...
              <td>
<a href="<?= BASE_URL ?>/animal/detalhes?id=<?= $animal['id'] ?>">Ver</a>
<a href="<?= BASE_URL ?>/animal/editar?id=<?= $animal['id'] ?>">Editar</a>
<a href="<?= BASE_URL ?>/animal/excluir?id=<?= $animal['id'] ?>">Excluir</a>
              </td>
